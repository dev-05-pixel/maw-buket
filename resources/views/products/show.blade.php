...
.detail-breadcrumb-inner a:hover { color: var(--charcoal); }
.detail-breadcrumb-inner span:last-child { color: var(--charcoal); }
...
@media (max-width: 720px) {
    ...
    .cta-wa-btn { flex: none; width: 100%; }
}
    ...
    <div class="gallery-side reveal-left">
        <div class="gallery-thumbs" id="gallery-thumbs" role="list" aria-label="Thumbnail gambar">
            ...
            <img
                ...
                alt="Tampilan buket {{ $i + 1 }}"
                class="gallery-thumb {{ $i === 0 ? 'active' : '' }}"
                data-full="https://picsum.photos/seed/{{ $seed }}/900/1200"
                data-index="{{ $i }}"
                role="listitem"
        ...
        <div class="gallery-main-wrap">
            ...
            <img
                id="gallery-main"
                src="https://picsum.photos/seed/detail-main/900/1200"
                alt="{{ $product->name ?? 'Blushing Garden' }}"
            ...
            <div class="gallery-nav-btns" id="gallery-dots" aria-hidden="true">
                @foreach ($seeds as $i => $seed)
                <button class="gallery-nav-dot {{ $i === 0 ? 'active' : '' }}" data-index="{{ $i }}" aria-label="Gambar {{ $i + 1 }}"></button>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <div class="info-side reveal-right">
        ...
        <div class="product-cta">
            <div class="product-cta-btns">
                <a
                    href="https://wa.me/628xxxxxxxxxx?text=Halo, saya ingin memesan {{ urlencode($product->name ?? 'Blushing Garden') }}"
                    target="_blank"
                    rel="noopener"
                    class="cta-wa-btn"
        ...
        <div class="details-accordion">
            @php
            $accordions = [
                ['title' => 'Detail Produk', 'content' => '<ul><li>Mawar premium grade A</li><li>Baby breath segar</li><li>Dedaunan eucalyptus pilihan</li><li>Dibungkus kertas korea premium</li><li>Pita satin eksklusif</li></ul>'],
                ['title' => 'Ukuran & Tinggi', 'content' => '<ul><li>Mini (S): tinggi ±25 cm, diameter ±15 cm</li><li>Standar (M): tinggi ±35 cm, diameter ±20 cm</li><li>Besar (L): tinggi ±45 cm, diameter ±28 cm</li><li>Grand (XL): tinggi ±60 cm, diameter ±35 cm</li></ul>'],
                ['title' => 'Cara Perawatan', 'content' => '<p>Letakkan buket di tempat sejuk dan tidak terkena sinar matahari langsung. Ganti air setiap 2 hari sekali dan potong sedikit ujung tangkai secara diagonal untuk memperpanjang kesegaran. Bunga segar kami umumnya bertahan 5-7 hari dengan perawatan yang tepat.</p>'],
                ['title' => 'Pengiriman', 'content' => '<p>Kami menyediakan pengiriman same-day untuk area Jakarta Selatan, Jakarta Pusat, dan sekitarnya (pemesanan sebelum pukul 13.00 WIB). Untuk area lain dan luar kota, pemesanan minimal H-2. Kami bekerja sama dengan kurir terpercaya untuk memastikan buket Anda tiba dalam kondisi segar dan sempurna.</p>'],
            ];
            @endphp
            ...
            <div class="accordion-item">
                ...
                <div
                    class="accordion-content {{ $i === 0 ? 'open' : '' }}"
...
<section class="related-section" aria-label="Produk terkait">
    ...
    <div class="related-grid">
        ...
        $related = [
            ...
            ['seed' => 'rel-2', 'name' => 'Cotton Candy Cloud','cat' => 'Mini Bouquet', 'price' => 'Rp 115.000'],
        ...
        <a href="{{ url('/products/' . ($i + 10)) }}" class="product-card reveal delay-{{ $i + 1 }}" aria-label="{{ $p['name'] }}">
            <div class="product-card-img-wrap">
                <img
                    src="https://picsum.photos/seed/{{ $p['seed'] }}/480/640"
                    alt="{{ $p['name'] }}"
