        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input list="color-list" name="color" value="{{ old('color', $product->color) }}"
                ...
                <div>
                    ...
                    <select name="size" class="w-full border border-cream-d rounded-xl px-4 py-3 text-sm text-brown bg-white
                        focus:outline-none focus:ring-2 focus:ring-rose/30 focus:border-rose/50 transition
