...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .fp-step.active { color: var(--rose-light); }
        .fp-step.done   { color: var(--sage); }
        ...
        .fp-inp::placeholder { color: rgba(248, 243, 236, 0.25); }
        ...
        .fp-submit:hover::before { transform: translateY(0); }
        ...
        .fp-submit:disabled::before { display: none; }
        ...
        .fp-back:hover { color: rgba(248, 243, 236, 0.8); }
        ...
        .resend-btn:hover { color: var(--rose); }
        .resend-btn:disabled { color: rgba(248, 243, 236, 0.25); cursor: not-allowed; text-decoration: none; }
...
<div class="fp-bg" aria-hidden="true">
    <img
        src="https://picsum.photos/seed/fp-bg/1400/900"
        alt=""
        class="fp-bg-img"
    />
...
<div class="fp-wrapper">
    ...
    <div class="fp-card" role="main">
        ...
        {{-- Step indicator --}}
        <div class="fp-steps" aria-label="Langkah-langkah reset password">
        ...
        <div id="fp-form-state">
            ...
            <p class="fp-subtitle">
                Tidak perlu khawatir. Masukkan alamat email administrator Anda dan kami akan mengirimkan tautan untuk mereset password.
            </p>
            ...
            <div class="fp-tip" role="note">
                ...
                Tautan reset akan dikirim ke email yang terdaftar. Periksa juga folder spam jika email tidak muncul dalam 5 menit.
            </div>

            <form method="POST" action="{{ url('/admin/forgot-password') }}" id="fp-form" aria-label="Form reset password">
                @csrf
        ...
        <div class="fp-success" id="fp-success-state" aria-live="polite" role="status">
            ...
            <p class="fp-success-desc">
                Kami telah mengirimkan tautan reset password ke <strong id="sent-email" style="color:var(--cream);">—</strong>. Tautan berlaku selama 60 menit.
            </p>
...
@if(session('status') === 'passwords.sent')
    showSuccess('{{ old("email", session("email", "")) }}');
@endif
...
function startTimer(timerId, btnId) {
    ...
    btnEl.addEventListener('click', function() {
        ...
        secs = 60;
        timerEl.textContent = secs;
        // Re-trigger form submission or AJAX
        if (fpForm) fpForm.submit();
    }, { once: true });
}
</script>
