...
<head>
    ...
    <meta name="description" content="{{ $meta_description ?? 'Maw Bouquet — Rangkaian bunga segar & kering penuh cerita, dikirim langsung ke tangan Anda.' }}" />
    <title>{{ $title ?? 'Maw Bouquet' }} | Maw Bouquet</title>

    {{-- Google Fonts --}}
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600&family=Jost:wght@300;400;500;600&family=Playfair+Display:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet" />
...
<body>
    ...
    <nav id="navbar" role="navigation" aria-label="Main navigation">
        ...
        <ul class="nav-links">
            ...
            <li><a href="{{ url('/products') }}" class="{{ request()->is('products*') ? 'active' : '' }}">Koleksi</a></li>
            <li><a href="{{ url('/contact') }}" class="{{ request()->is('contact') ? 'active' : '' }}">Kontak</a></li>
            <li>
                <a href="https://wa.me/628xxxxxxxxxx" target="_blank" rel="noopener" class="nav-cta">
    ...
    <div id="mobile-nav" role="dialog" aria-label="Mobile navigation" aria-hidden="true">
        ...
        <a href="https://wa.me/628xxxxxxxxxx" target="_blank" rel="noopener" class="mobile-nav-link">WhatsApp</a>
    </div>
        ...
        <div class="footer-grid">
            <div class="reveal">
                ...
                <p class="footer-tagline">
                    Setiap rangkaian adalah karya seni yang tumbuh dari hati — untuk momen yang tak terlupakan dalam hidup Anda.
                </p>
                <div class="footer-socials">
                    {{-- Instagram --}}
                    <a href="#" class="footer-social-icon" aria-label="Instagram" target="_blank" rel="noopener">
                    ...
                    {{-- WhatsApp --}}
                    <a href="https://wa.me/628xxxxxxxxxx" class="footer-social-icon" aria-label="WhatsApp" target="_blank" rel="noopener">
                        <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="reveal delay-2">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="https://wa.me/628xxxxxxxxxx" target="_blank" rel="noopener">Pesan via WA</a></li>
                </ul>
            </div>
