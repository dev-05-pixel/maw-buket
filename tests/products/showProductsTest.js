...
(async function showProductPageTest() {
    ...
    const logFile =
        path.join(
            logDir,
            'showProductPageTest.log'
        );

    const reportFile =
        path.join(
            reportDir,
            'showProductPageReport.html'
        );
    ...
    try {
        ...
        const successImageName =
            `show-product-success-${timestamp}.png`;
...
<head>
    ...
    <title>Show Product Page Test Report</title>
...
<body>
    ...
    <h1>Show Product Page Test Report</h1>

    <table>

        <tr>
            <th>Test Name</th>
            <td>Show Product Page Test</td>
        </tr>
...
`;
        ...
        console.log(
            'Show product page test passed'
        );

    } catch (err) {

        console.error(
            'Show product page test failed'
        );
        ...
        const failedImageName =
            `show-product-failed-${timestamp}.png`;
